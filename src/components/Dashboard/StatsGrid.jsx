  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4'>
        {stats.map((stats, index) => (
         ...
         hover:shadow-xl hover:shadow-slate-200/20 dark:hover:shadow-slate-900/20 transition-all duration-300 group'
         key={index}>
...
<div  className={`w-full bg-linear-to-r ${stats.color} rounded-full transition-all duration-100`}
