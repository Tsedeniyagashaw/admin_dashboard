...
<div className='flex-1 max-w-md mx-8'>
  <div className='relative'>
    ...
    className='w-full pl-10 pr-4 py-2.5 bg-slate-100 dark:bg-slate-800 border
     ...
     '
    />
    <button className='absolute right-2 top-1/2 transform -translate-y-1/2 p-1.5 text-slate-600 dark:hover:text-slate-300 '>
      <Filter />
    </button>
...
<div className='hidden md:block'>
  <p className='text-sm font-medium text-slate-500 dark:text-salte-400'>Jane Jhonson</p>
