...
const Sidebar = ({ collapsed, onToggle, currentPage, onPageChange }) => {
  ...
  return (
    <div className= {`${collapsed ? 'w-20' : 'w-72'} transition-all duration-300 ease-in-out bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-r border-slate-200/50 dark:border-slate-700/50
...
<button className={`w-full flex items-center justify-between p-3
  ...
  ${currentPage === item.id || item.active 
    ? "bg-linear-to-r from-blue-500 to-purple-600 text-white shadow-lg shadow-blue-500/25"
     : "text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:bg-slate-800/50"
